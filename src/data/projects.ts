...
,
  {
    ...
    "overview": "BIENGUAL은 CNN 뉴스 기사 및 YouTube 콘텐츠 기반의 자막을 수집해, 사용자에게 리딩·리스닝 학습을 제공하는 영어 학습 플랫폼입니다. \n영상 및 기사 콘텐츠를 통해 문장 단위 학습, 단어/문장 북마크, 퀴즈 생성, 진행률 트래킹까지 하나의 흐름으로 연결된 러닝 경험을 제공합니다.",
    "roles": [
  ...
  },
  {
    ...
    "overview": "react-player-plugin-prompter는 영어 영상 학습을 위한 자막 하이라이팅 및 탐색 기능에 특화된 React 기반 오픈소스 컴포넌트 라이브러리입니다. \n영상 재생 시간에 맞춰 자막을 자동으로 스크롤하고, 사용자가 자막을 클릭하여 해당 시간으로 이동할 수 있는 기능을 제공합니다. \n성능 최적화, 범용성, 개발자 사용성을 고려하여 설계하였습니다.",
    "roles": [
      "전체 설계 및 구현 담당",
