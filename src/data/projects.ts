...
export const projects: ProjectData[] = [
  {
    ...
    overview:
      'Next Table Order는 포스기 없이 주문을 받던 식당 아르바이트 경험에서 출발한 웹 기반 테이블 오더 시스템입니다.\n고객은 테이블의 QR을 스캔해 메뉴를 주문하고, 운영자는 실시간으로 주문을 확인하고 처리할 수 있습니다.\n단순한 CRUD를 넘어, 주문 단위 모델링, 자동 초기화, 실시간 SSE 최적화, 옵션 처리 등 실사용 환경을 반영한 기능을 설계했습니다.\nNext.js 기반 SSR과 Supabase Realtime 기능을 활용해 실시간성과 유지보수성을 확보했고,\n비개발자도 쉽게 사용할 수 있도록 UX 흐름에 집중하여 설계·개발한 프로젝트입니다.',
    roles: [
      '식당 현장 문제 해결을 위한 주문 흐름 기획 및 전체 설계',
      'Next.js 기반 SSR 구조 및 실시간 처리 로직 구현',
      'SSE 최적화 및 트래픽 절감을 위한 주문 이벤트 모델링',
      '비개발자도 사용할 수 있도록 UX 흐름 및 UI 설계 중심 개발',
      'next-intl을 활용한 i18n 다국어 구조 설계 및 실제 시연 적용',
    ],
    stack: [
  ...
  },
  {
    ...
    overview:
      'BIENGUAL은 CNN 뉴스 기사 및 YouTube 자막 기반 콘텐츠를 크롤링해 리딩·리스닝 학습을 제공하는 영어 학습 플랫폼입니다.\n사용자는 영상 및 기사 콘텐츠를 통해 문장 단위로 학습하고, 북마크, 메모, 퀴즈, 대시보드를 통해 학습 흐름을 이어갈 수 있습니다.\n퀴즈 설계, 진행률 시각화, 반복 학습 기능 등 몰입 기반 러닝 경험 설계에 집중하였고,\n성능 최적화와 검색 노출 기반 설정 등 제품 완성도를 높이기 위한 기술 구현을 주도했습니다.',
    roles: [
      '프론트엔드 리더로서 UI/UX 흐름 및 기술 구조 설계 주도',
      '이벤트 기반 퀴즈 상태 설계 및 반복 학습 구조 구현',
      'Next.js App Router + 서버 컴포넌트 기반 구조화',
      '이미지 최적화, 병렬 API 요청 등 성능 개선 주도',
      'SEO, CDN, 반응형 UI 등 사용자 경험 강화 기능 다수 구현',
    ],
    stack: [
  ...
  },
  {
    ...
    overview:
      'react-player-plugin-prompter는 영어 학습 플랫폼 BIENGUAL 개발 중, 학습 흐름에 맞는 자막 컴포넌트를 찾기 어려워 직접 만든 React 기반 오픈소스 컴포넌트 라이브러리입니다. Cake 등의 자막 UX를 참고해 성능·사용성·확장성을 모두 고려해 설계하였습니다.',
    roles: [
      '전체 라이브러리 설계 및 구현 주도',
